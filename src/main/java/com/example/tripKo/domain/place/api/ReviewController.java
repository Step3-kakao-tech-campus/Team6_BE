...
public class ReviewController {
  ...
  public ResponseEntity<?> createPlaceRestaurantReview(@AuthenticationPrincipal JwtUserDetails jwtUserDetails,
  ...
  public ResponseEntity<?> updatePlaceRestaurantReviews(@PathVariable Long reviewId,
      @ModelAttribute @Valid ReviewUpdateRequest reviewUpdateRequest) {
  ...
  */
  ...
  public ResponseEntity<?> createFestivalReview(@AuthenticationPrincipal JwtUserDetails jwtUserDetails,
      @ModelAttribute @Valid ReviewRequest reviewRequest) {
    Member member = jwtUserDetails.getMember();
  ...
  public ResponseEntity<?> updateFestivalReviews(@PathVariable Long reviewId,
      @ModelAttribute @Valid ReviewUpdateRequest reviewUpdateRequest) {
    reviewService.updateReview(reviewId, reviewUpdateRequest);
    ApiUtils.ApiResult<?> apiResult = ApiUtils.success(null);
    return ResponseEntity.ok(apiResult);
  ...
  */
  ...
  public ResponseEntity<?> createTouristSpotReview(@AuthenticationPrincipal JwtUserDetails jwtUserDetails,
      @ModelAttribute @Valid ReviewRequest reviewRequest) {
    Member member = jwtUserDetails.getMember();
  ...
  public ResponseEntity<?> updateTouristSpotReviews(@PathVariable Long reviewId,
      @ModelAttribute @Valid ReviewUpdateRequest reviewUpdateRequest) {
    reviewService.updateReview(reviewId, reviewUpdateRequest);
    ApiUtils.ApiResult<?> apiResult = ApiUtils.success(null);
    return ResponseEntity.ok(apiResult);
